...
export const PRODUCTS = [
  ...
  },
  {
    ...
    detail: {
      comment: [
        "가벼운 소재로 피부에 닿는 느낌이 편안한 가디건 이에요",
        "한여름에도 쾌적하게 입기 좋으며, 약간의 비침이 있는 소재가 데일리하게 즐기기 좋답니다",
        "특히 힙을 살짝 가리는 여유 있는 기장감과 넉넉한 핏이 체형을 자연스럽게 커버해주며",
        "여리여리한 실루엣을 완성해줘요",
        "바디에 유연하게 감기면서도 답답하지 않아 활동하기 좋고,",
        "툭 걸치기만 해도 세련된 무드를 연출해주는 데일리 아이템이랍니다 :)",
      ],
    },
  },
  {
